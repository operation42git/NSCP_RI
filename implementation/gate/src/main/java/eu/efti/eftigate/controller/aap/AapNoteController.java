...
import eu.efti.eftigate.controller.aap.api.AapNoteControllerApi;
...
@AllArgsConstructor
@Slf4j
public class AapNoteController implements AapNoteControllerApi {

    private final ControlService controlService;

    @Override
    public ResponseEntity<NoteResponseDto> createNote(final @Valid @RequestBody PostFollowUpRequestDto notesDto) {
        log.info("POST on /aap/control/uil/follow-up with param requestId {}", notesDto.getRequestId());
